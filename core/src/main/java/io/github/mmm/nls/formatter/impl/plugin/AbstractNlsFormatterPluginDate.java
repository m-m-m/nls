...
public abstract class AbstractNlsFormatterPluginDate extends AbstractNlsFormatterPluginSimple {
  ...
  /**
   * This method converts the given {@link io.github.mmm.nls.formatter.NlsFormatterPlugin#getStyle() style} to the
   * according {@link DateFormat}-style constant.
   *
   * @param style is the {@link io.github.mmm.nls.formatter.NlsFormatterPlugin#getStyle() style} to convert.
