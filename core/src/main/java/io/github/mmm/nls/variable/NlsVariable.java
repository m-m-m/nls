...
/**
 * A variable is a placeholder for an {@link NlsArguments#get(String) argument} an argument of an {@link NlsMessage}. An
 ...
 * <tr>
 * <td>justification</td>
 * <td>a {@link Justification#of(String) justification}</td>
 * </tr>
 * </table>
 *
 * <br>
...
public class NlsVariable {
   ...
   */
  public NlsVariable(String key, NlsFormatterPlugin formatter, Justification justification) {
  ...
  public String toString() {
    ...
    sb.append(NlsVariableParser.START_EXPRESSION);
    sb.append(this.key);
    if (!(this.formatter instanceof NlsFormatterPluginDefault)) {
      sb.append(NlsVariableParser.FORMAT_SEPARATOR);
      sb.append(this.formatter);
    }
    if (this.justification != null) {
      sb.append(NlsVariableParser.START_EXPRESSION);
      sb.append(this.justification);
      sb.append(NlsVariableParser.END_EXPRESSION);
    }
    sb.append(NlsVariableParser.END_EXPRESSION);
    return sb.toString();
  }
