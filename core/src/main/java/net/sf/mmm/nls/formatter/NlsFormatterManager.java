...
import net.sf.mmm.nls.formatter.impl.NlsFormatterManagerImpl;
...
public interface NlsFormatterManager {
  ...
  /** @see net.sf.mmm.nls.formatter.impl.plugin.NlsFormatterPluginChoice */
   ...
   * {@link net.sf.mmm.nls.formatter.impl.plugin.NlsFormatterPluginChoice}).
   *
