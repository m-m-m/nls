 ...
 * <b>ATTENTION:</b><br>
 * The {@link net.sf.mmm.nls.formatter.NlsFormatterManager#getFormatter() default formatter} is NOT stored in this map.
 *
 * @see net.sf.mmm.nls.formatter.impl.ConfiguredNlsFormatterMap
 */
public class NlsFormatterMap {
  ...
  /**
   * @see net.sf.mmm.nls.formatter.NlsFormatterManager#getFormatter(String, String)
   *
   * @param formatType is the type to be formatted.
