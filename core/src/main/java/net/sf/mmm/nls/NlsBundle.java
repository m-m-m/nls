...
import net.sf.mmm.nls.descriptor.NlsBundleDescriptor;
 ...
 * locale}.</li>
 * <li>By default the {@link net.sf.mmm.nls.descriptor.NlsMessageDescriptor#getMessageKey() message key} used in the
 * method implementation (see example below) shall be the {@link java.lang.reflect.Method#getName() method name}.</li>
 * <li>You have to ensure that the {@link net.sf.mmm.nls.descriptor.NlsMessageDescriptor#getMessageKey() message key}s
 * are unique within an {@link NlsBundle} class as otherwise the localization is NOT possible.</li>
 ...
 * </pre>
 *
 * See {@link net.sf.mmm.nls.variable.NlsVariable} for advanced features.
 */
public class NlsBundle implements NlsBundleDescriptor, NlsArgumentsKeys {
  ...
  /**
   * @param key the {@link net.sf.mmm.nls.descriptor.NlsMessageDescriptor#getMessageKey() message key}.
