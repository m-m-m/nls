...
package net.sf.mmm.nls.template.impl;
...
import net.sf.mmm.nls.descriptor.NlsMessageDescriptor;
...
/**
 * Implementation of the {@link net.sf.mmm.nls.template.NlsTemplate} using {@link ResourceBundle}s for localization.
 */
public class NlsTemplateImpl implements NlsTemplate, NlsMessageDescriptor {
  ...
  protected String translateFallback(Exception e) {
    ...
    LOG.warn("Failed to resolve message {}:{}", this.bundleName, this.messageKey, e);
