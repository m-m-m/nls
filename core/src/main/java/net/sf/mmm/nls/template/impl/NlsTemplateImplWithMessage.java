...
/**
 * Extends {@link NlsTemplateImpl} with the {@link net.sf.mmm.nls.NlsMessage#getInternationalizedMessage()
...
public class NlsTemplateImplWithMessage extends NlsTemplateImpl {
   ...
   * @param message is the {@link net.sf.mmm.nls.NlsMessage#getInternationalizedMessage() internationalized message}.
   */
